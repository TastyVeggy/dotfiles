...
vim.opt.hlsearch = true                  -- Disable highlight on search results
...
vim.opt.conceallevel = 1                 -- Hide text with the "conceal" syntax attribute except in cursor line
...
vim.opt.fillchars =
"eob: " -- Fill characters for end of buffer lines (empty lines after the end of the file)
